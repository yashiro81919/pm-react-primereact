...
function Key() {
    ...
    const searchKeys = () => {
        ...
        keyService.searchKeys(filter).then(resp => {
            setKeys(resp.data);
    ...
    return (
        <React.Fragment>
            ...
            <div className="p-component">
                ...
                <Button label="Search" className="p-button-outlined p-button-secondary ml-2" onClick={searchKeys} />
            ...
            <Dialog header={isEdit ? 'Update Key' : 'Add Key'} visible={displayModal} onHide={() => { setDisplayModal(false) }} modal={true} style={{ width: '25vw' }} draggable={false} resizable={false} footer={renderFooter}>
                <div className="card">
